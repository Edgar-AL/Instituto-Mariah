...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Range(0, 1)] public float RunningAudioVolume = 0.5f;

        [Header("Breathing Sound")]
        public AudioClip BreathingClip;
        [Range(0, 1)] public float BreathingVolume = 0.3f;
        ...
        private void Start()
        {
            ...
            _runningAudioSource.clip = RunningAudioClip;
            _runningAudioSource.volume = RunningAudioVolume;
            _runningAudioSource.loop = true;
            _runningAudioSource.playOnAwake = false;
            _runningAudioSource.spatialBlend = 0f;

            _breathingAudioSource = gameObject.AddComponent<AudioSource>();
            _breathingAudioSource.clip = BreathingClip;
            _breathingAudioSource.volume = BreathingVolume;
            _breathingAudioSource.loop = true;
            _breathingAudioSource.playOnAwake = false;
            _breathingAudioSource.spatialBlend = 0f;
        }
        ...
        private void Move()
        {
            ...
            // Control de sonido de correr
            if (_input.move != Vector2.zero && _input.sprint)
            {
                if (!_runningAudioSource.isPlaying)
